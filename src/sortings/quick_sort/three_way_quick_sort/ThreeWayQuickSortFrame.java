 ...
 */
public class ThreeWayQuickSortFrame extends JFrame {

    private int canvasWidth;
    private int canvasHeight;

    public ThreeWayQuickSortFrame(String title, int canvasWidth, int canvasHeight) {
        super(title);
        ...
        ThreeWayQuickSortFrame.AlgorithmCanvas canvas = new ThreeWayQuickSortFrame.AlgorithmCanvas();
